                ...
                <div className="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full  xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
                    <div className="max-w-md w-full space-y-8">
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500">please login with your password</p>
                        </div>
                        <div className="flex">
                        ...
                        <div className="w-full max-w-lg">
                            ...
                            <div className="space-y-6 mt-6">
                                ...
                                <div>
                                    <button onClick={login} type="submit" className="item-center w-full flex justify-center bg-pink-400  hover:bg-pink-500 text-gray-100 p-3  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                                        {
                                            isloading ?
                                                <>
